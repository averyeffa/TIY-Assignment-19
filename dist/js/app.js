...
var githubApiKey = '933b4d9e6732e3340aed12eb0b783b42af334ccc';
...
var fetchUserProfileData = _jquery2.default.getJSON('https://api.github.com/users/' + userLogin);
var fetchUserRepoData = _jquery2.default.getJSON('https://api.github.com/users/' + userLogin + '/repos');
...
inputValEl.addEventListener('keydown', function (evt) {
  ...
  if (evt.keyCode === 13) {
    ...
    fetchUserProfileData = _jquery2.default.getJSON('https://api.github.com/users/' + userLogin);
    fetchUserRepoData = _jquery2.default.getJSON('https://api.github.com/users/' + userLogin + '/repos');
    // console.log(fetchUserRepoData, fetchUserProfileData)
    _jquery2.default.when(fetchUserProfileData, fetchUserRepoData).then(function (data1, data2) {
...
_jquery2.default.when(fetchUserProfileData, fetchUserRepoData).then(function (userProfileData, userRepoData) {
